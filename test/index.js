...
describe('API ENDPOINT TESTING', () => {
    ...
    it('POST Booking Page', (done) => {
        const image = __dirname + '/buktibayartes.jpeg'
        const dataSample = {
            image,
            ...
            phoneNumber: '0892301832',
            accountHolder: 'Abdurrahman',
            bankFrom: 'BNI'
        }
        ...
        chai.request(app).post('/api/v1/member/booking-page')
            ...
            .attach('image', fs.readFileSync(dataSample.image), 'buktibayartes.jpeg')
            .end((err, res) => {
                expect(err).to.be.null
